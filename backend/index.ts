...
mongoose.connect(process.env.MONGODB_URI || "mongodb://localhost:27017/treehacks-application-portal-local", { useNewUrlParser: true, useUnifiedTopology: true }).catch(function (reason: string) {
