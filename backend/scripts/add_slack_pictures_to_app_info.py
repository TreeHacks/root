...
for app in applications:
    ...
    if 'profilePicture' in app['forms']['application_info'] and image_link == app['forms']['application_info']['profilePicture']:
        continue
    db.applications.update_one({
        '_id': app['_id']
    },{
        '$set': {
            'forms.application_info.profilePicture': image_link
        }
    }, upsert=False)
    count += 1
