...
export default () => <div className="admitted-content">
    ...
    <p>We will contact you by the end of January with more information if we're able to offer you a spot at TreeHacks. Stay tuned and be on the lookout for updates from us in the future.</p>
    <p>Hacker love,</p>
