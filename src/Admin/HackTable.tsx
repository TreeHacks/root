                    ...
                    {(state, makeTable, instance) => {
                        return (
                            <React.Fragment>
                                ...
                                <p><button className="btn btn-sm btn-outline-primary" onClick={() => props.getExportedApplications(state, columnsToExport)}>Export public data as JSON (for expo.treehacks.com)</button></p>
