...
class FormPageWrapper extends React.Component<IFormPageWrapperProps, { showSavedAlert: boolean }> {
    ...
    render() {
        ...
        if (get(schema, 'properties.accept_share')) {
            schema.properties.accept_share.title = <span>I authorize you to share my application/registration information for event administration, ranking, pre- and post-event informational e-mails, and occasional messages about hackathons in-line with the <a className="form-link" href="https://www.treehacks.com/privacy-policy" target="_blank" onClick={e => e.stopPropagation()}>TreeHacks Privacy Policy</a>.</span>;
        }
