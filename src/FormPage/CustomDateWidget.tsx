...
import { CustomDateWidgetProps, CustomDateWidgetState } from "./types";
...
function rangeOptions(start, stop, type) {
  let options = [];
...
function DateElement(props) {
  ...
  return (
    <SelectWidget
      ...
      options={{ enumOptions: rangeOptions(range[0], range[1], type) }}
...
class AltDateWidget extends Component<CustomDateWidgetProps, CustomDateWidgetState> {
  static defaultProps = {
    time: false,
    disabled: false,
    readonly: false,
