...
export class Transportation extends React.Component<ITransportationProps> {
  ...
  render() {
    ...
    if (status !== STATUS.ADMITTED && status !== STATUS.ADMISSION_CONFIRMED) {
      ...
      return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <div className="treehacks-alert" style={{maxWidth: '500px', margin: '60px 0 0 0', padding: '20px' }}>
    ...
    if (transportation_status === TRANSPORTATION_STATUS.UNAVAILABLE) {
      return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <div className="treehacks-alert" style={{ maxWidth: '700px', padding: '40px 20px' }}>
      ...
      return (
        <div className="transportation" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <div className="treehacks-alert">
            ...
            <h5>TreeHacks is reimbursing you up to <span className="treehacks-transportation-amount-text">{transportationAmount.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</span></h5>
